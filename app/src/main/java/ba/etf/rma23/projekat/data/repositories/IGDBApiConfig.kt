...
class IGDBApiConfig {
    ...
    companion object {
        const val FIELDS =
            "id,name,release_date.human,age_ratings.rating,age_ratings.category,platforms.name,involved_companies.company.name,rating,genres.name,cover.url,summary;"
